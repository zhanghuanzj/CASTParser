...
public class StProtectSectionNode extends StNodeID implements StDGNode {
	...
	public StProtectSectionNode(long ID, String Name, long ClassID, int Startline, int Stopline) {
		id = new ElementID(ID);
	...
	public StProtectSectionNode(String Name, long ClassID, int Startline, int Stopline) {
		id = new ElementID(-1);
		name = new ElementName(Name);
		classID = new ElementClassID(ClassID);
		startline = new ElementStartline(Startline);

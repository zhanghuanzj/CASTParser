...
public class StConnectionReceiveNode extends StNodeID implements StDGNode {
	...
	public StConnectionReceiveNode(long ID, String Name, long MethodID, int Startline, File Path) {
		id = new ElementID(ID);
	...
	public StConnectionReceiveNode(String Name, long MethodID, int Startline, File Path) {
		id = new ElementID(-1);
		name = new ElementName(Name);
		methodID = new ElementMethodID(MethodID);
		startline = new ElementStartline(Startline);

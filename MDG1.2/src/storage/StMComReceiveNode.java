...
public class StMComReceiveNode extends StNodeID implements StDGNode{
	...
	public StMComReceiveNode (long ID,String Name,long MethodID,int Startline,File Path){
		id = new ElementID(ID);
	...
	public StMComReceiveNode (String Name,long MethodID,int Startline,File Path){
		id = new ElementID(-1);
		name = new ElementName(Name);
		methodID = new ElementMethodID(MethodID);
		startline = new ElementStartline(Startline);

...
public class NEO4JAccess {
	...
	public static final Label TriggerNode = DynamicLabel.label("n42");
	public static final Label InterruptNotify = DynamicLabel.label("n43");
	public static final Label InterruptAccept = DynamicLabel.label("n44");

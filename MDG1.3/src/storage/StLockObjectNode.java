...
public class StLockObjectNode extends StNodeID implements StDGNode {
	...
	public StLockObjectNode(long ID, String Name, long ClassID, String Type, boolean[] Modifier) {
		id = new ElementID(ID);
	...
	public StLockObjectNode(String Name, long ClassID, String Type, boolean[] Modifier) {
		id = new ElementID(-1);
		name = new ElementName(Name);
		classID = new ElementClassID(ClassID);
		modifier = new ElementModifier(Modifier);

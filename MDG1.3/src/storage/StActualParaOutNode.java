...
public class StActualParaOutNode extends StNodeID implements StDGNode {
	...
	public StActualParaOutNode(long ID, String Name, long MethodID, int Startline, String Type) {
		id = new ElementID(ID);
	...
	public StActualParaOutNode(String Name, long MethodID, int Startline, String Type) {
		id = new ElementID(-1);
		name = new ElementName(Name);
		methodID = new ElementMethodID(MethodID);
		startline = new ElementStartline(Startline);
